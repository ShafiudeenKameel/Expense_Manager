...
def expenses():
    ...
    for expense in expenses:
        ...
        if expense.category == "buisness":
            t_buisness += expense.amount
    ...
    return render_template('expenses.html',expenses=expenses, total=total, t_buisness=t_buisness, t_entertainment=t_entertainment, t_other=t_other,t_food=t_food)
